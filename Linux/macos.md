...
| iproute2mac<br>                                         | brew install iproute2mac to provide the `ip` command |
| docker colima docker-buildx                             | Running docker runtime                               |
| derailed/k9s/k9s                                        | Monitor k8s                                          |
| brew go                                                 | Golang                                               |
| brew tfenv + terraform                                  |                                                      |
| kubectl                                                 |                                                      |
